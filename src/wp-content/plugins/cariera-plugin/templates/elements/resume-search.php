 ...
 *
 * This template can be overridden by copying it to cariera-child/cariera_core/elements/resume-search.php.
 *
 * @package     cariera
 * @category    Template
 * @since       1.7.2
...
<form method="GET" action="<?php echo esc_url( get_permalink( get_option( 'resume_manager_resumes_page_id' ) ) ); ?>" class="resume-search-form <?php echo esc_attr( $settings['search_style'] ); ?> <?php echo esc_attr( $settings['custom_class'] ); ?>">
