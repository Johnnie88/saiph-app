...
2. For services using a database, environment variables have been pre-configured under the `env` node in the following files to allow connection to the database. Modify the name of these variables as needed to match your application.
    ...
    - [app/kirki-pro-headline-divider.bicep](./infra/app/kirki-pro-headline-divider.bicep)
    - [app/kirki-pro-input-slider.bicep](./infra/app/kirki-pro-input-slider.bicep)
    - [app/kirki-pro-margin-padding.bicep](./infra/app/kirki-pro-margin-padding.bicep)
    - [app/kirki-pro-responsive.bicep](./infra/app/kirki-pro-responsive.bicep)
    - [app/kirki-pro-tabs.bicep](./infra/app/kirki-pro-tabs.bicep)
...
- [app/kirki-pro-headline-divider.bicep](./infra/app/kirki-pro-headline-divider.bicep) - Azure Container Apps resources to host the 'kirki-pro-headline-divider' service.
- [app/kirki-pro-input-slider.bicep](./infra/app/kirki-pro-input-slider.bicep) - Azure Container Apps resources to host the 'kirki-pro-input-slider' service.
- [app/kirki-pro-margin-padding.bicep](./infra/app/kirki-pro-margin-padding.bicep) - Azure Container Apps resources to host the 'kirki-pro-margin-padding' service.
- [app/kirki-pro-responsive.bicep](./infra/app/kirki-pro-responsive.bicep) - Azure Container Apps resources to host the 'kirki-pro-responsive' service.
- [app/kirki-pro-tabs.bicep](./infra/app/kirki-pro-tabs.bicep) - Azure Container Apps resources to host the 'kirki-pro-tabs' service.
