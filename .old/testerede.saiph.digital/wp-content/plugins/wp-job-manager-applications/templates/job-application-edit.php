...
<form class="job-manager-application-edit-form job-manager-form" method="post">
	...
	<fieldset class="fieldset-status">
		<label for="application-status-<?php echo esc_attr( $application->ID ); ?>"><?php esc_html_e( 'Application status', 'wp-job-manager-applications' ); ?>:</label>
		<div class="field">
	...
	<fieldset class="fieldset-rating">
		<label for="application-rating-<?php echo esc_attr( absint( $application->ID ) ); ?>"><?php esc_html_e( 'Rating (out of 5)', 'wp-job-manager-applications' ); ?>:</label>
		<div class="field">
			<input type="number" id="application-rating-<?php echo esc_attr( absint( $application->ID ) ); ?>" name="application_rating" step="0.1" max="5" min="0" placeholder="0" value="<?php echo esc_attr( get_job_application_rating( $application->ID ) ); ?>" />
		</div>
	</fieldset>

	<p>
		<a class="delete_job_application" href="<?php echo wp_nonce_url( add_query_arg( 'delete_job_application', $application->ID ), 'delete_job_application' ); ?>"><?php esc_html_e( 'Delete', 'wp-job-manager-applications' ); ?></a>
