...
?>
<input type="checkbox" class="input-checkbox" name="<?php echo esc_attr( isset( $field['name'] ) ? $field['name'] : $key ); ?>"
	   id="<?php echo esc_attr( $key ); ?>" <?php checked( ! empty( $value ), true ); ?> value="1" <?php if ( ! empty( $field['required'] ) ) {
	echo 'required';
} ?> />
