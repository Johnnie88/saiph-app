...
class Taxonomy extends Job_Manager {
	...
	public function __construct() {
		...
		// Add field.
		add_action( 'job_listing_category_add_form_fields', [ $this, 'category_add_new_meta_field' ], 10, 2 );

		// Edit Field.
		add_action( 'job_listing_category_edit_form_fields', [ $this, 'category_edit_meta_field' ], 10, 2 );
